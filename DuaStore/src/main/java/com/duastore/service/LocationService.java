...
public class LocationService {
    ...
    public List<Map<String, Object>> getProvinces() {
        if (fileLoaded) return provinceList;
        try {
    ...
    public List<Map<String, Object>> getDistricts(String provinceCode) {
        ...
        if (districtCache.containsKey(provinceCode) && !fileLoaded) return districtCache.get(provinceCode);
        if (districtCache.containsKey(provinceCode)) return districtCache.get(provinceCode);
        try {
    ...
    public List<Map<String, Object>> getWards(String districtCode) {
        ...
        if (wardCache.containsKey(districtCode)) return wardCache.get(districtCode);
        try {
