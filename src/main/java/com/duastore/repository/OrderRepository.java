...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query("SELECT o FROM Order o WHERE "
            ...
            + "(:trangThaiTT IS NULL OR :trangThaiTT = 'CHO_XAC_NHAN_CK' OR o.trangThaiTT = :trangThaiTT) AND "
            + "(:trangThaiTT IS NULL OR :trangThaiTT <> 'CHO_XAC_NHAN_CK' OR (o.phuongThucTT = 'CHUYEN_KHOAN' AND o.trangThaiTT = 'CHUA_THANH_TOAN')) AND "
