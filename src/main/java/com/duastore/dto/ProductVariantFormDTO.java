...
/**
 * DTO dùng cho form Thêm / Sửa biến thể sản phẩm (Admin)
 * Mỗi biến thể = 1 SKU: dung tích + kiểu nắp + giá + tồn kho + ảnh riêng
 *
 * @author anhpl
 */
@Data
...
public class ProductVariantFormDTO {
    ...
    /**
     * Giá khuyến mãi (null = không có KM)
     * Nên nhỏ hơn giaGoc — validate trong Service
     */
    ...
    /**
     * true = biến thể này được hiển thị mặc định khi vào trang chi tiết SP
     * Chỉ 1 biến thể/sản phẩm được isDefault = true
     */
