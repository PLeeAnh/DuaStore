...
function openDetailModal(promoId) {
    ...
    fetch('/khuyen-mai/' + promoId)
            ...
            .then(function (d) {
                ...
                el('dm-footer-action').innerHTML = d.ownedInWallet
                        ? '<button class="ds-btn ds-btn-fill" disabled style="opacity:.6;cursor:not-allowed;"><i class="bi bi-check-circle-fill me-1"></i>Đã nhận</button>'
